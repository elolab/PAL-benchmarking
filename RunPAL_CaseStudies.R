...
# Run PAL with adjusting for age and using time from seroconversion as the feature of interest
pal_time_DAISY = PAL(data=data, info=info_DAISY, grouplabels="Labels", adjust="Age", mainfeature="TimeFromSeroconversion", userandom="Donor", 
                     adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", nodemin=1, seed=1234)
...
# Run PAL with adjusting for age and using sample groups as the feature of interest
pal_group_DAISY = PAL(data=data, info=info_DAISY, grouplabels="Labels", adjust="Age", mainfeature="SampleGroup", userandom="Donor", 
                      adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", nodemin=1, seed=1234)
...
# Run PAL with adjusting for age and using time from seroconversion as the feature of interest
pal_time_pbmc = PAL(data=log2(data_pbmc+1), info=info_Diabimmune[colnames(data_pbmc),,drop=F], grouplabels="Label", adjust="Age", mainfeature="TimeFromSero", 
                    userandom="Donor", adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
pal_time_cd4 = PAL(log2(data_cd4+1), info=info_Diabimmune[colnames(data_cd4),,drop=F], grouplabels="Label", adjust="Age", mainfeature="TimeFromSero", 
                   userandom="Donor", adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
pal_time_cd8 = PAL(log2(data_cd8+1), info=info_Diabimmune[colnames(data_cd8),,drop=F], grouplabels="Label", adjust="Age", mainfeature="TimeFromSero", 
                   userandom="Donor", adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
# Run PAL with adjusting for age and using samplegroup as the feature of interest
pal_group_pbmc = PAL(log2(data_pbmc+1), info=info_Diabimmune[colnames(data_pbmc),,drop=F], grouplabels="Label", adjust="Age", mainfeature="SampleGroup", 
                     userandom="Donor", adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
pal_group_cd4 = PAL(log2(data_cd4+1), info=info_Diabimmune[colnames(data_cd4),,drop=F], grouplabels="Label", adjust="Age", mainfeature="SampleGroup", 
                    userandom="Donor", adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
pal_group_cd8 = PAL(log2(data_cd8+1), info=info_Diabimmune[colnames(data_cd8),,drop=F], grouplabels="Label", adjust="Age", mainfeature="SampleGroup", 
                    userandom="Donor", adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
# Run PAL with adjusting for age and using time from serovonversion as the feature of interest
pal_time_BabyDiet = PAL(data=data, info=info_BabyDiet, grouplabels="Labels", adjust="Age", mainfeature="TimeFromSero", userandom="Donor", 
                        adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
...
# Run PAL with adjusting for age and using sample group as the feature of interest
pal_group_BabyDiet = PAL(data=data, info=info_BabyDiet, grouplabels="Labels", adjust="Age", mainfeature="SampleGroup", userandom="Donor", 
                         adjustmentmodel="lmer", pathwaymodel="lmer", score="activity", seed=1234)
